          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="number" name="harga" value="{{old('harga')}}" class="form-control @error('harga') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Masukkan Harga buku" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('harga')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="number" name="stok" value="{{old('stok')}}" class="form-control @error('stok') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Masukkan Stok Buku" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('stok')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
